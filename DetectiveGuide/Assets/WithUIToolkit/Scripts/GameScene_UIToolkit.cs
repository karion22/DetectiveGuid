...
public class GameScene_UIToolkit : MonoBehaviour
{
    private ListView m_ListView = null;

    private VisualTreeAsset m_CardItemPrefab = null;
    private List<CardItem_UIToolkit> m_CardItems = new List<CardItem_UIToolkit>();
    ...
    private void Awake()
    {
        ...
        {
            CardItem_UIToolkit item = new CardItem_UIToolkit();
            //item.UserName = 
        }
        ...
        root.Q<Button>("LogBtn").clicked += () => {
            ...
            if (asset != null)
            {
                ...
                UIUtility_UIToolkit.SetPopup(popup);
                root.Add(popup);
            }
        };
